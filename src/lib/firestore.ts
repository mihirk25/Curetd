...
type LegalNameProfileData = {
  firstName?: unknown;
  lastName?: unknown;
  hasLegalName?: unknown;
} | null;

export function getLegacyLegalName(data: LegalNameProfileData): {
  firstName: string;
  lastName: string;
} | null {
...
export function profileNeedsLegalName(data: LegalNameProfileData): boolean {
